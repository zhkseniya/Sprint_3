...
public class CourierParameterizedTest {
    ...
    public static Object[][] getCourierData() {
        return new Object[][] {
                ...
                {Courier.getWithLoginAndPassword(), 201, null},
        };
    }

    @Test
    @DisplayName("Сreating a courier with a different set of parameters: /api/v1/courier")
    @Description("Courier creation: with login only; only with a password; only with a name; with login and password, but no name")
